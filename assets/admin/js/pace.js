!(function (t, e) {
  var n = (function (t) {
        ...
        for (
          q = {
            ...
            T = function () {
              ...
              for (
                e = arguments[0],
                  r = 2 <= arguments.length ? $.call(arguments, 1) : [],
                  i = 0,
                  s = r.length;
                i < s;
                i++
            ...
            k = function (t) {
              var e, n, r, o, i;
              for (n = e = 0, o = 0, i = t.length; o < i; o++)
                  ...
                  if (
                    ...
                    for (o = 0, u = []; o < this.bindings[n].length; )
                      (a = this.bindings[n][o]),
                        ...
                        i ? u.push(this.bindings[n].splice(o, 1)) : u.push(o++);
                    return u;
                  }
                }),
                t
        ...
        (d = (function (t) {
          ...
          (s = (function () {
            ...
            return (
              (t.prototype.getElement = function () {
                var t;
                if (null == this.el) {
                  if (!(t = document.querySelector(E.target))) throw new d();
              ...
              (t.prototype.render = function () {
                ...
                for (
                  t = this.getElement(),
                    ...
                    o = 0,
                    i = (s = ["webkitTransform", "msTransform", "transform"])
                      .length;
                  o < i;
                  o++
                )
            ...
            return (
              (t.prototype.trigger = function (t, e) {
                ...
                if (null != this.bindings[t]) {
                  for (
                    i = this.bindings[t], s = [], r = 0, o = i.length;
                    r < o;
                    r++
                  )
          ...
          (X = function (t) {
            ...
            if (!_.length && E.ajax) {
              ...
              if (((e = t.toUpperCase()), nt.call(E.ajax.trackMethods, e) >= 0))
                return !0;
            }
            return !1;
          }),
            ...
            function e() {
              ...
              e.__super__.constructor.apply(this, arguments),
                (t = function (t) {
                  ...
                  return (
                    (e = t.open),
                    (t.open = function (r, o, i) {
                      return (
                        X(r) &&
                          n.trigger("request", { type: r, url: o, request: t }),
                        e.apply(t, arguments)
                      );
                    })
                  );
          ...
          (W = function (t) {
            var e, n, r, o;
            for (o = E.ajax.ignoreURLs, n = 0, r = o.length; n < r; n++)
          ...
          (O = function () {
            ...
            var e, n, r, o, s;
            if (((o = t.type), (r = t.request), (s = t.url), !W(s)))
              return f.running ||
                (!1 === E.restartOnRequestAfter && "force" !== X(o))
                ? void 0
                : ((n = arguments),
                  "boolean" == typeof (e = E.restartOnRequestAfter || 0) &&
                    (e = 0),
                  setTimeout(function () {
                    var t, e, s, a, u;
                    if (
                      "socket" === o
                        ? r.readyState < 2
                        : 0 < (s = r.readyState) && s < 4
                    ) {
                      for (
                        f.restart(), a = f.sources, u = [], t = 0, e = a.length;
                        t < e;
                        t++
                      ) {
          ...
          (i = (function () {
            ...
            return (
              (t.prototype.watch = function (t) {
                var e, n, r, o;
                if (((r = t.type), (e = t.request), (o = t.url), !W(o)))
                  return (
                    (n = "socket" === r ? new v(e) : new w(e)),
            ...
            if (((this.progress = 0), null != window.ProgressEvent))
              for (
                t.addEventListener(
                  ...
                  n = 0,
                  r = (i = ["load", "abort", "timeout", "error"]).length;
                n < r;
                n++
              )
                (e = i[n]),
          ...
          (v = function (t) {
            var e,
              ...
              i = this;
            for (
              this.progress = 0, n = 0, r = (o = ["error", "open"]).length;
              n < r;
              n++
            )
              (e = o[n]),
              ...
              (e = setInterval(function () {
                ...
                return (
                  ...
                  ++r >= E.eventLag.minSamples && t < E.eventLag.lagThreshold
                    ? ((i.progress = 100), clearInterval(e))
                    : (i.progress = (3 / (t + 3)) * 100)
                );
              }, 50));
          }),
          (y = (function () {
            function t(t) {
              (this.source = t),
                ...
                null != this.source &&
                  (this.progress = C(this.source, "progress"));
            }
            return (
              (t.prototype.tick = function (t, e) {
                var n;
                return (
                  null == e && (e = C(this.source, "progress")),
                  e >= 100 && (this.done = !0),
                  e === this.last
          ...
          (m = { ajax: i, elements: u, document: a, eventLag: c }),
          (M = function () {
            var t, e, n, r, o, i, a, u;
            for (
              f.sources = H = [],
                e = 0,
                r = (i = ["ajax", "elements", "document", "eventLag"]).length;
              e < r;
              e++
            )
              !1 !== E[(t = i[e])] && H.push(new m[t](E[t]));
            for (
              u = null != (a = E.extraSources) ? a : [], n = 0, o = u.length;
              n < o;
              n++
            )
              (D = u[n]), H.push(new D(E));
            return (f.bar = L = new s()), (U = []), (I = new y());
          })(),
          (f.stop = function () {
            return (
              f.trigger("stop"),
              ...
              L.destroy(),
              (x = !0),
              null != b && ("function" == typeof S && S(b), (b = null)),
              M()
            );
          }),
          (f.restart = function () {
          ...
          (f.go = function () {
            ...
            return (
              ...
              (x = !1),
              (b = F(function (e, n) {
                var r, o, i, s, a, u, l, c, p, h, d, g, m, v, w;
                for (
                  L.progress, o = h = 0, i = !0, u = d = 0, m = H.length;
                  d < m;
                  u = ++d
                )
                  for (
                ...
                return (
                  ...
                  L.done() || i || x
                    ? (L.update(100),
                      f.trigger("done"),
                      setTimeout(function () {
                        return L.finish(), (f.running = !1), f.trigger("hide");
                      }, Math.max(
                        E.ghostTime,
                        Math.max(E.minTime - (A() - t), 0)
                      )))
                    : n()
                );
              }))
          ...
          (f.start = function (t) {
            ...
            return document.querySelector(".pace")
              ? (f.trigger("start"), f.go())
              : setTimeout(f.start, 50);
          }),
          (r = [n(451)]),
          void 0 ===
            (o = function () {
    ...
    453: function (t, e, n) {
      ...
      (window.paceOptions = { startOnPageLoad: !1 }),
        (function () {
          if (!document.getElementById("pace-js-stylesheets")) {
            var t = document.createElement("style");
            (t.type = "text/css"),
              (t.id = "pace-js-stylesheets"),
              (t.innerHTML =
