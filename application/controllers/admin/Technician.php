...
class Technician extends Admin_Controller 
{
	public function __construct()
	{
		...
		$this->data['page_title'] = 'Technician Page';
		

		$this->load->model('admin/Model_technician');
	...
	public function index($cat_id = NULL){
		...
		$list_data = $this->Model_technician->getTechnicianList($parent_cat_id,true);

		$this->data['list_data'] = $list_data;

		$this->render_template('admin/technician/index', $this->data);
	}
	...
	public function create()
	{
        ...
        if ($this->form_validation->run() == TRUE) {
            ...
            $this->render_template('admin/technician/addedit', $this->data);
        }
	}
	...
	{
		if($id) {
			$delete = $this->Model_technician->changeStatus($this->atri->de($id),$this->input->get('val'));
			if($delete == true) {
			...
			redirect('admin/technician/', 'refresh');
