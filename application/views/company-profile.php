...
<div class="addres-area black-bg section-padding">
    <div class="container">
        <div class="row align-items-center justify-content-center">
            <div class="section-title text-center mb-10" style="color:white">
                <h3 style="color:white">We provide all of your <br>
            ...
            <div class="col-xl-4 col-md-4">
                <div class="single-address ">
                    <ul class="unordered-list">
                        <li>
                            <h3>Rich vendor base</h3>
                        </li>
                        <li><h3>High-quality product range</h3></li>
                        <li><h3>Ethical business policies</h3></li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-4 col-md-4">
                <div class="single-address ">
                    <ul class="unordered-list">
                        <li><h3>Large distribution network</h3></li>
                        <li><h3>Client-centric approach</h3></li>
                        <li><h3>Reasonable prices</h3></li>
                    </ul>
                </div>
            </div>
            <div class="col-xl-4 col-md-4">
                <div class="single-address ">
                    <ul class="unordered-list">
                        <li><h3>Transparent dealings</h3></li>
                        <li><h3>Excellent transport & logistic facility</h3></li>
                    </ul>
                </div>
            </div>
        </div>
