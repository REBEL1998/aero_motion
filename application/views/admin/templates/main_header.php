    ...
    <div class="layout-wrapper layout-2">
        <div class="layout-inner">
            ...
            <div class="layout-container">
                ...
                <!-- Sidenav toggle (see <?php echo base_url("assets/admin/css/demo/demo.css"); ?>) -->
                        ...
                        <div class="demo-navbar-user nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">
                                <span class="d-inline-flex flex-lg-row-reverse align-items-center align-middle">
                                    <img src="<?php echo base_url("assets/admin/img/avatars/1.png"); ?>" alt class="d-block ui-w-30 rounded-circle">
                                    <span class="px-1 mr-lg-2 ml-2 ml-lg-0">Admin</span>
                                </span>
                            </a>
                            <div class="dropdown-menu dropdown-menu-right">
                                <a href="<?php echo base_url('admin/auth/logout');?>" class="dropdown-item"><i class="feather icon-power text-danger"></i> &nbsp; Log Out</a>
                            </div>
                        </div>
                    </div>
                </div>
